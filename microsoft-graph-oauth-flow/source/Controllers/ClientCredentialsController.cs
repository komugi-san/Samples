...
namespace WebApplication1.Controllers
{
    ...
    public class ClientCredentialsController : Controller
    {
        ...
        public async Task<ActionResult> GetTokenV1()
        {
            ...
            var resource = Settings.Default.ResourceUrl;
        ...
        {
            var requestUrl = "https://login.microsoftonline.com/" + Settings.Default.TenantName + "/oauth2/v2.0/token";
            var clientId = Settings.Default.ClientId;
            var scope = Settings.Default.ResourceUrl + "/.default";
            var clientSecret = Settings.Default.ClientSecret;
            var requestContent =
                "client_id=" + Uri.EscapeDataString(clientId) + "&" +
